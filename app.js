...
const fetchPrice = async (ctype) => {
  ...
  res.innerHTML = `<tr style="background-color:#000000; color:white; font-weight:600">
              <td>Property</td>
              <td>Value</td>
            </tr>
            <tr style="background-color:#000000; color:white; font-weight:600">
              <td>Base</td>
              <td>"${base}"</td>
            </tr>
            <tr style="background-color:#000000; color:white; font-weight:600">
            ...
            <tr style="background-color:#000000; color:white; font-weight:600">
              <td>Price</td>
              <td style="backgroundcolor:#000000; color:white"; ><b>${price}</b></td>
            </tr>
            <tr style="background-color:#000000; color:white; font-weight:600">
              <td>Volume(24hrs)</td>
              <td>${volume}</td>
  ...
  xyz.innerHTML = `<h5 >(Note : Volume is displayed only for the cryptocurrencies that are actually traded on online exchanges.)
  <font color="black" size="3.5"></font>
  </h5>
          <p>
            <h2 align="left">
            <font color="#5d8aa8" size="5.5">
              <b><u> Params: </u></b>
            </font>
            </h2>
              <table>
